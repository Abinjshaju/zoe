...
def interactive_setup() -> None:
    ...
    one optional public URL. Writes to ``~/.hermes/.env`` via ``zoe_cli.config``.
    """
    print()
    ...
    try:
        from zoe_cli.config import get_env_var, set_env_var
    except ImportError:
        print("zoe_cli.config not available; set LINE_* vars manually in ~/.hermes/.env")
        return
