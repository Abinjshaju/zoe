...
Component separation:
    ...
    gui.log receives dashboard-side records from ``zoe_cli.web_server``,
    ``zoe_cli.pty_bridge``, ``tui_gateway.*``, and ``uvicorn.*``.
...
from zoe_constants import get_config_path, get_hermes_home
...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    def __init__(self, *args, **kwargs):
        from zoe_cli.config import is_managed
