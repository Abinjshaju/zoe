...
from zoe_cli.cli_output import prompt_yes_no
from zoe_cli.curses_ui import curses_single_select
from zoe_cli.mcp_catalog import (
    CatalogEntry,
    CatalogError,
    catalog_diagnostics,
    install_entry,
...
def _configure_tools(name: str) -> None:
    ...
    """
    import argparse
    from zoe_cli.mcp_config import cmd_mcp_configure
...
def install_by_name(identifier: str) -> int:
    ...
    exit codes).
    """
    from zoe_cli.mcp_catalog import get_entry
