...
from zoe_cli.nous_subscription import (
    apply_nous_managed_defaults,
    get_nous_subscription_features,
)
from zoe_cli.nous_account import format_nous_portal_entitlement_message
...
from zoe_cli.cli_output import (  # noqa: E402 — late import block
...
def _xai_credentials_present() -> bool:
    ...
    """
    try:
        from zoe_cli.auth import _read_xai_oauth_tokens
...
def _get_effective_configurable_toolsets():
    ...
    try:
        from zoe_cli.plugins import discover_plugins, get_plugin_toolsets
...
from zoe_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
...
def _run_post_setup(post_setup_key: str):
    ...
    if post_setup_key in {"agent_browser", "browserbase"}:
        ...
        try:
            from zoe_cli.auth import login_spotify_command
        except Exception as exc:
        ...
        try:
            from zoe_cli.plugins_cmd import _get_enabled_set, _save_enabled_set
