...
from zoe_cli.auth import AuthError, resolve_provider
from zoe_cli.colors import Colors, color
from zoe_cli.config import get_env_path, get_env_value, get_hermes_home, load_config
from zoe_cli.models import provider_label
from zoe_cli.nous_account import (
    format_nous_portal_entitlement_message,
    get_nous_portal_account_info,
)
from zoe_cli.nous_subscription import get_nous_subscription_features
from zoe_cli.runtime_provider import resolve_requested_provider
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from zoe_cli.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from zoe_cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
