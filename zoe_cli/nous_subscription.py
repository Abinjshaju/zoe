...
from zoe_cli.config import get_env_value, load_config
...
# coverage category (zoe_cli.nous_account.TOOL_COVERAGE_CATEGORIES). Lets the
...
def prompt_enable_tool_gateway(
    ...
    *,
    ...
    try:
        from zoe_cli.setup import prompt_checklist
    except Exception:
        return set()
