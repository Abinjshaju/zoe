...
from zoe_cli.config import get_hermes_home, get_config_path, read_raw_config
from zoe_constants import OPENROUTER_BASE_URL, secure_parent_dir
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from zoe_cli.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def _nous_shared_auth_dir() -> Path:
    ...
    :func:`zoe_constants.get_default_hermes_root` returns — so
...
def _get_azure_foundry_auth_status() -> Dict[str, Any]:
    ...
    try:
        from zoe_cli.config import load_config, get_env_value
        cfg = load_config()
    except Exception:
        cfg = {}
...
def _prompt_model_selection(
    ...
    """
    from zoe_cli.models import _format_price_per_mtok
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
    from zoe_cli.config import save_config, load_config
