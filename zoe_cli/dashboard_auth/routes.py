...
from zoe_cli.dashboard_auth import (
    get_provider,
    list_providers,
)
from zoe_cli.dashboard_auth.audit import AuditEvent, audit_log
from zoe_cli.dashboard_auth.base import (
    InvalidCodeError,
...
from zoe_cli.dashboard_auth.login_page import render_login_html
...
def _redirect_uri(request: Request) -> str:
    ...
    from zoe_cli.dashboard_auth.prefix import (
        prefix_from_request,
        resolve_public_url,
    )
...
def _prefix(request: Request) -> str:
    ...
    ``zoe_cli.dashboard_auth.prefix`` for the normalisation rules.
    """
...
async def api_auth_ws_ticket(request: Request):
    ...
    from zoe_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
