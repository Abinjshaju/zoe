...
_PROFILE_DIRS = [
    ...
    # See zoe_constants.get_subprocess_home().
    "home",
]
...
def _maybe_register_gateway_service(profile_name: str) -> None:
    ...
    try:
        ...
        from zoe_cli.service_manager import get_service_manager
...
def _cleanup_gateway_service(name: str, profile_dir: Path) -> None:
    ...
    try:
        ...
        from zoe_cli.gateway import get_service_name, get_launchd_plist_path
