...
from zoe_constants import get_hermes_home, get_optional_mcps_dir
...
from zoe_cli.cli_output import prompt as _prompt_input
...
def _probe_tools(name: str) -> Optional[List[tuple]]:
    ...
    try:
        ...
        from zoe_cli.mcp_config import _probe_single_server
...
def install_entry(entry: CatalogEntry, *, enable: bool = True) -> None:
    ...
    from zoe_cli.mcp_config import _save_mcp_server
