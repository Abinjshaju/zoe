...
from zoe_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
def get_git_banner_state(repo_dir: Optional[Path] = None) -> Optional[dict]:
    ...
    if repo_dir is None:
        ...
        try:
            from zoe_cli.build_info import get_build_sha
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    try:
        from zoe_cli.codex_runtime_switch import get_current_runtime
        from zoe_cli.config import load_config as _load_cfg
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from zoe_cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
