...
from zoe_constants import display_hermes_home, is_termux as _is_termux_environment
...
class CLICommandsMixin:
    ...
    def _handle_paste_command(self):
        ...
        from zoe_cli.clipboard import has_clipboard_image
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from zoe_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from zoe_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from zoe_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to zoe_cli.curator so the CLI and the `hermes curator`
        ...
        try:
            from zoe_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_kanban_command(self, cmd: str):
        ...
        """
        from zoe_cli.kanban import run_slash
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to zoe_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            from zoe_cli.write_approval_commands import handle_pending_subcommand
            ...
            if out is not None:
                print(out)
                return
        from zoe_cli.skills_hub import handle_skills_slash
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from zoe_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from zoe_cli.models import _is_anthropic_fast_model
    ...
    def _handle_debug_command(self):
        ...
        from zoe_cli.debug import run_debug_share
    ...
    def _handle_update_command(self) -> bool:
        ...
        when cancelled.
        """
        from zoe_cli.config import is_managed, format_managed_message
