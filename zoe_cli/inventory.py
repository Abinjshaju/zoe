...
def build_models_payload(
    ...
    *,
    ...
    try:
        from zoe_cli.providers import is_aggregator as _is_aggregator
    except Exception:
...
def _append_unconfigured_rows(rows: list[dict], ctx: ConfigContext) -> list[dict]:
    ...
    from zoe_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
...
def _reorder_canonical(rows: list[dict]) -> list[dict]:
    ...
    """
    from zoe_cli.models import CANONICAL_PROVIDERS
