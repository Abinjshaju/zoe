...
from zoe_cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
...
class PluginContext:
    ...
    def register_dashboard_auth_provider(self, provider) -> None:
        ...
        ``provider`` must be an instance of
        :class:`zoe_cli.dashboard_auth.DashboardAuthProvider`. Used by
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        # Lazy import to avoid circular: zoe_cli.main imports plugins indirectly
        from zoe_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
