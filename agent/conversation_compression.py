...
def compress_context(
    ...
    *,
    ...
    # long-lived ``zoe_state.SessionDB`` class still bound to the
    ...
    if agent._session_db:
        try:
            ...
            if in_place:
                ...
                # from ``zoe_logging._session_context`` (set once per turn in
                ...
                try:
                    from zoe_cli.goals import migrate_goal_to_session
