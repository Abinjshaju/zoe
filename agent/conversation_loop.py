...
from zoe_constants import PARTIAL_STREAM_STUB_ID
from zoe_logging import set_session_context
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                try:
                    from zoe_cli.middleware import apply_llm_request_middleware
                ...
                from zoe_cli.middleware import run_llm_execution_middleware
