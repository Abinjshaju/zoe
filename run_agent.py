...
def _routermint_headers() -> dict:
    ...
    from zoe_cli import __version__ as _HERMES_VERSION
...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            ...
            from zoe_cli.models import ensure_lmstudio_model_loaded
    ...
    def _invoke_api_request_error_hook(
        ...
        *,
        ...
        # ``monkeypatch.setattr("zoe_cli.plugins.has_hook", ...)`` still
        ...
        try:
            from zoe_cli import plugins as _plugins
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from zoe_cli.copilot_auth import resolve_copilot_token
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from zoe_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from zoe_cli.models import lmstudio_model_reasoning_options
